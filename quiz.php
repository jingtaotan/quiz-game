	...
	<div class="container">
		...
		<div id="quiz-screen">
			<div class="panel panel-default">
				<div class="panel-body question" id="question-txt">
				</div>
			</div>

			<div class="list-group answers">
				<a href="#" class="list-group-item answer" id="answer1-txt">
					&nbsp;
				</a>
				<a href="#" class="list-group-item answer" id="answer2-txt">
					&nbsp;
				</a>
				<a href="#" class="list-group-item answer" id="answer3-txt">
					&nbsp;
				</a>
				<a href="#" class="list-group-item answer" id="answer4-txt">
					&nbsp;
				</a>
			</div>
		</div>
		...
		$(document).ready(function() {
			...
			var startQuiz = function() {
				...
				setTimeout(function() {
					...
					var target_date = new Date(new Date().getTime() + 60000); // 1 extra second to show 01:00
					...
					timerInterval = setInterval(function () {
						...
						var tenths_second = parseInt((milliseconds_left % 1000) / 100); // only display 1 decimal place after seconds
